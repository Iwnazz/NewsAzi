...
fun EmptyScreen(error : LoadState.Error? = null){
    ...
    var icon by remember {
        mutableIntStateOf(R.drawable.baseline_report_gmailerrorred_24)
    }

    if (error == null){
        messages = "You haven't saved news so far!"
    ...
    val alphaAnimation by animateFloatAsState(
        ...
        animationSpec = tween(DURATION), label = ""
    )
    ...
    EmptyContent(alphaAnimation, messages, icon)
}
